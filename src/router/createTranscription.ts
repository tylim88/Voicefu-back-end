...
import {
    ...
    createTranscription as createTranscriptionAI,
} from '~/openai_api'
...
export const createTranscription: AppRouteImplementation<
    (typeof contracts)['createTranscription']
> = async ({ req }) => {
    ...
    try {
        ...
        const transcriptionResponse = await createTranscriptionAI({
            readStream: stream,
        })
